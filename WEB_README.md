...
На Windows 10 проще всего запускать через `start_local_proxy.bat` (двойной
клик или из командной строки) - он сам поставит зависимости при первом
запуске и держит окно консоли открытым:
